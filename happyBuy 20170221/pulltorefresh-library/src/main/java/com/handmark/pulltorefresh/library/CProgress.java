...
/**
 * Created by 陈尤岁 on 2016/12/30.
 */

public class CProgress extends View {

    private final static String TAG = "CProgress.java";

    public CProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttributeset(context , attrs , defStyleAttr) ;
        init(context);
    }
    public CProgress(Context context, AttributeSet attrs) {
        super(context, attrs);
