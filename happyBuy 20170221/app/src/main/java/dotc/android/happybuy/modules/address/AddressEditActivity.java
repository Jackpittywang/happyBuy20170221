...
import dotc.android.happybuy.persist.location.LocationManager;
...
public class AddressEditActivity extends BaseActivity implements View.OnClickListener {
    ...
    private LocationManager.Region mUserOptProvince;
    private LocationManager.Region mUserOptDistrict;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mExtraPostcode = intent.getStringExtra(EXTRA_POSTCODE);
    ...
    private void initExtraUI(){
        ...
        if(!TextUtils.isEmpty(mExtraProvince)){
            mUserOptProvince = LocationManager.Region.newRegion(mExtraProvince);
            if(mUserOptProvince!=null){
                mProvinceTextView.setText(mExtraProvince);
            }
        }
        if(!TextUtils.isEmpty(mExtraDistrict)){
            mUserOptDistrict = LocationManager.Region.newRegion(mExtraDistrict);
    ...
    private void showProvinceSelector(final View view) {
        ...
        new AsyncTask<String, Integer, List<LocationManager.Region>>() {
            @Override
            protected List<LocationManager.Region> doInBackground(String... params) {
                return mLocationManager.getProvince();
            }
            @Override
            protected void onPostExecute(final List<LocationManager.Region> strings) {
                        ...
                        .setAdapter(new DialogLisAdapter(GlobalContext.get(), strings), new
                                DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        LocationManager.Region region = strings.get(which);
                                        dialog.dismiss();
                                        if(mUserOptProvince==null||!mUserOptProvince.enValue.equals(region.enValue)){
                                            mUserOptProvince = region;
                                            mProvinceTextView.setText(region.enValue+"/"+region.thValue);
                                ...
                                DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if(mUserOptDistrict==null||!mUserOptDistrict.enValue.equals(region.enValue)){
                                            ...
                                            mDistrictTextView.setText(mUserOptDistrict.enValue + "/" + mUserOptDistrict.thValue);
    ...
    private void doSaveViewClick(View view) {
        ...
        map.put("state", mUserOptProvince.enValue+"/"+mUserOptProvince.thValue);
        map.put("city", mUserOptDistrict.enValue+"/"+mUserOptDistrict.thValue);
        map.put("zipcode", mUserOptPostcode);
        String url = null;
        if (curmode == MODE_ADD) {
        ...
        Network.get(GlobalContext.get()).asyncPost(url, map, new Network.JsonCallBack<JSONObject>() {
            ...
            public void onSuccess(JSONObject jsonObject) {
                ...
                ToastUtils.showShortToast(AddressEditActivity.this, "add success");
    ...
    class DialogLisAdapter extends BaseAdapter {
        ...
        private List<LocationManager.Region> mLists;
        private Context mContext;
        private LayoutInflater mInflater;

        public DialogLisAdapter(Context context, List<LocationManager.Region> list) {
            mLists = list;
            mContext = context;
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            ...
            final LocationManager.Region language = mLists.get(position);
            holder.textView.setText(language.enValue+"/"+language.thValue);
