 ...
 */
public class ParticipateRecordAdapter extends BaseAdapter {

    private final String TAG = this.getClass().getSimpleName();
    private List<PojoParticpateHistory> mPojoCategoryList;
    private ChildParticipateFragment mFragment;
...
//    private AppIconLoader mAppIconLoader;
    ...
    public ParticipateRecordAdapter(ChildParticipateFragment fragment){
