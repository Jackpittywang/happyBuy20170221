 ...
 */
public class RepackTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link RepackTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link RepackTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    public RepackTabLayout(Context context) {
        this(context, null);
    }

    public RepackTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RepackTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RepackTabLayout,
                defStyleAttr, R.style.TabLayout);

        mTabStrip.setSelectedIndicatorHeight(
                a.getDimensionPixelSize(R.styleable.RepackTabLayout_tabIndicatorHeight, 0));
        mTabStrip.setSelectedIndicatorColor(a.getColor(R.styleable.RepackTabLayout_tabIndicatorColor, 0));

        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a
                .getDimensionPixelSize(R.styleable.RepackTabLayout_tabPadding, 0);
        mTabPaddingStart = a.getDimensionPixelSize(R.styleable.RepackTabLayout_tabPaddingStart,
                mTabPaddingStart);
        mTabPaddingTop = a.getDimensionPixelSize(R.styleable.RepackTabLayout_tabPaddingTop,
                mTabPaddingTop);
        mTabPaddingEnd = a.getDimensionPixelSize(R.styleable.RepackTabLayout_tabPaddingEnd,
                mTabPaddingEnd);
        mTabPaddingBottom = a.getDimensionPixelSize(R.styleable.RepackTabLayout_tabPaddingBottom,
                mTabPaddingBottom);


        mTabTextSize = a.getDimensionPixelSize(R.styleable.RepackTabLayout_tabTextSize, 0);
        mTabTextColors = a.getColorStateList(R.styleable.RepackTabLayout_tabTextColor);

//        mTabTextSize = AppUtil.dp2px(context,14);


//        mTabTextColors = ta.getColorStateList(R.styleable.TextAppearance_android_textColor);


        if (a.hasValue(R.styleable.RepackTabLayout_tabTextColor)) {
            // If we have an explicit text color set, use it instead
            mTabTextColors = a.getColorStateList(R.styleable.RepackTabLayout_tabTextColor);
        }

        if (a.hasValue(R.styleable.RepackTabLayout_tabSelectedTextColor)) {
            // We have an explicit selected text color set, so we need to make merge it with the
            // current colors. This is exposed so that developers can use theme attributes to set
            // this (theme attrs in ColorStateLists are Lollipop+)
            final int selected = a.getColor(R.styleable.RepackTabLayout_tabSelectedTextColor, 0);
            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), selected);
        }

        mRequestedTabMinWidth = a.getDimensionPixelSize(R.styleable.RepackTabLayout_tabMinWidth,
                INVALID_WIDTH);
        mRequestedTabMaxWidth = a.getDimensionPixelSize(R.styleable.RepackTabLayout_tabMaxWidth,
                INVALID_WIDTH);
        mTabBackgroundResId = a.getResourceId(R.styleable.RepackTabLayout_tabBackground, 0);
        mContentInsetStart = a.getDimensionPixelSize(R.styleable.RepackTabLayout_tabContentStart, 0);
        mMode = a.getInt(R.styleable.RepackTabLayout_tabMode, MODE_FIXED);
        mTabGravity = a.getInt(R.styleable.RepackTabLayout_tabGravity, GRAVITY_FILL);
        a.recycle();
    ...
    /**
     * Set the OnTabSelectedListener that will
    ...
    /**
     * Returns the current mode used by this {@link RepackTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * The one-stop shop for setting up this {@link RepackTabLayout} with a {@link ViewPager}.
     *
     * <p>This method will:
     * <ul>
     ...
     *     <li>Set our {@link RepackTabLayout.OnTabSelectedListener} which will forward
    ...
    public static final class Tab {
        ...
        private final RepackTabLayout mParent;

        Tab(RepackTabLayout parent) {
            mParent = parent;
        }
...
//                mTextView.setTextAppearance(getContext(), mTabTextAppearance);
     ...
     * necessary calls back to the provided {@link RepackTabLayout} so that the tab position is
     * kept in sync.
     *
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<RepackTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(RepackTabLayout tabLayout) {
        ...
        public void onPageScrolled(int position, float positionOffset,
            ...
            final RepackTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link RepackTabLayout.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements RepackTabLayout.OnTabSelectedListener {
