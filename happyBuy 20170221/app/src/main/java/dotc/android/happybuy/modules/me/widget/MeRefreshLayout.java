...
public class MeRefreshLayout extends FrameLayout {
    ...
    private MeTabListViewPager viewPager;
...
//    private View loadMoreView;
    ...
    public MeRefreshLayout(Context context) {
        super(context);
        init(context);
    }

    public MeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if(firstLayout){
            ...
            viewPager = (MeTabListViewPager) getChildAt(3);
...
//            setState(State.RESET);
    ...
    public interface OnRefreshListener {
        void onRefresh(MeRefreshLayout refreshView);
    }
