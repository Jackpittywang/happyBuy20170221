 ...
 */
public class RedBagPayListUnAvailableAdpter extends BaseAdapter {
    private Context mContext;
    private List<PojoCoupons> mlist = new ArrayList<>();
    Set<Integer> checkPostions;
    private int mHaveSelect=0;
    public static final String TAG = "RedBagPayListUnAvailableAdpter";
    ...
    public RedBagPayListUnAvailableAdpter(Context context) {
        mContext = context;
    }
  ...
  /*  public void setPosition(int position){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_coupons_list_unavailable_in_pay, null);
