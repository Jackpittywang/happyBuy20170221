...
public class PrefUtils {
    ...
    public static boolean getBoolean(String key, boolean defaultValue) {
        return getBoolean(GlobalContext.get(), key, defaultValue);
    }
    public static boolean putBoolean(String key, boolean defaultValue) {
        return putBoolean(GlobalContext.get(), key, defaultValue);
    }
